...
if (controller.frameprev != controller.frame)
    ...
    for (i = 0; i < ds_list_size(controller.scan_list); i++)
        ...
        ypnpos = scanner_y+25*sinycalc*sin(trigopx);
        zpnpos = scanner_z+25*cos(trigopy);
...
for (i = 0; i < ds_list_size(controller.draw_list); i++)
    ...
    //d3d_draw_ellipsoid(scanner_x-0.02,scanner_y,scanner_z-0.02,scanner_x+0.02,scanner_y+0.04,scanner_z+0.02,background_get_texture(bck_scanner),1,1,15);
